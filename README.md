...
Based on that, scRNAseq datasets of FACS-sorted macrophages are favored most since they allow relatively high sequencing depths and macrophage abundance. Some atlas datasets are also employed to ensure enough dataset size.
